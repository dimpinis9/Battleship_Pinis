...
public class GridCreator extends JPanel {
	...
	private JButton endSetup, rotateShipsBtn;
	...
	public void setup() {
		...
		rotateShipsBtn = new JButton("Rotate");
		rotateShipsBtn.setBounds(buttonXPos, 0, window.getWidth() - buttonXPos, TILE_SIZE - 5);
		rotateShipsBtn.addActionListener(new ActionListener() {
			@Override
		...
		add(rotateShipsBtn);
		rotateShipsBtn.setVisible(true);
		repaint();

		// creates a button that ends setup when pressed
		endSetup = new JButton("Start Game");
